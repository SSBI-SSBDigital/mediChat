...
# UPLOAD_FOLDER = 'C:/LLAMA3LOCAL/uploads'
# REPORT_FOLDER = 'C:/LLAMA3LOCAL/reports'
# ANNOTATED_FOLDER = 'C:/LLAMA3LOCAL/annotated'
...
# # Annotate Image
# # base_image_path= r'C:\LLAMA3LOCAL\Humanschematic\five tips for gr.png'
...
#     draw = ImageDraw.Draw(base_image)
#     try:
#         font = ImageFont.truetype("arialbd.ttf", 10)  # Using bold Arial font
#     except IOError:
#         font = ImageFont.load_default()
...
#     if question.lower() in ['hi', 'hello', 'hey','Hey',' Hello']:
...
#     if question.lower() not in ['hi', 'hello', 'hey']:
#         base_image_path = r'C:\LLAMA3LOCAL\Humanschematic\five tips for gr.png'
#         annotated_image_path = annotate_image(base_image_path, annotations)
#         pdf_path = os.path.join(REPORT_FOLDER, 'Medical_Report.pdf')
#         generate_pdf_report(response, annotations, annotated_image_path, pdf_path)
...
# VERSION 3: FINAL WITH CHAT all formats    /////USE WITH PROD VERSION5
...
#     app.run(debug=True)
    ...
    # version 4: downloable file FINAL WITH LOCAL PATH
#     from flask import Flask, request, jsonify, send_file
# from flask_cors import CORS
# import pytesseract
# from PIL import Image, ImageDraw, ImageFont
...
# VERSION 5: PROD 2: VERSION 2 DISPLAYS RESPONSE, DONWLOADS FILE IN THE IDE. NO DISPLAY IN POSTMAN
# from flask import Flask, request, jsonify, send_file
# from flask_cors import CORS
# import pytesseract
# from PIL import Image, ImageDraw, ImageFont
...
#         return jsonify({"response": response, "download": pdf_path})
#     else:
#         response = ask_openai(question)
...
##TRAIL WITH MULTI LANG SUPPORT. THE ABOVE IS THE REAL CODE
# from flask import Flask, request, jsonify, send_file
# from flask_cors import CORS
# import pytesseract
# from PIL import Image, ImageDraw, ImageFont
...
#     file = request.files['file']
#     question = request.form.get('question', '')
#     preferred_language = request.form.get('language', 'en')  # Default to English
...
#         translated_response = translate_text(response, preferred_language)
...
#         generate_pdf_report(translated_response, annotations, annotated_image_path, pdf_path)
